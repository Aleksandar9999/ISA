    ...
    <div class="wrapper">
            <section class="content">
                ...
                <div class="grey-box-wrap">
                    <div class="top">
                        <a @click=subtractMonth class="prev"><i class="zmdi zmdi-chevron-left"></i>previous month</a>
                        <span class="center">{{headingText}}</span>
                        <a @click=addMonth class="next">next month<i class="zmdi zmdi-chevron-right"></i></a>
                    </div>
...
export default {
  ...
  mounted() {
    ...
    this.headingText=this.firstInMonth.format("MMMM") + ', ' + this.firstInMonth.format("yyyy")
  },
  methods: {
    addMonth() {
      this.firstInMonth= this.firstInMonth.add(1, "M");
      let daysBeforeFirst = this.firstInMonth.format("d") - 1;
      if (this.firstInMonth.format("d") == 0)// Ako je prvi nedelja
        daysBeforeFirst = 6;
