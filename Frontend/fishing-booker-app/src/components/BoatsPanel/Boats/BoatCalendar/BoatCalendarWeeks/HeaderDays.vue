...
export default {
    ...
    mounted() {
        ...
        this.$axios.get(`${config.apiStart}/api/appointments/${rola}/${this.$route.params.idboat}/calendar/month?startDate=${startDate.format("YYYY-MM-DD")}&endDate=${endDate.format("YYYY-MM-DD")}`)
        .then(resp=>{
